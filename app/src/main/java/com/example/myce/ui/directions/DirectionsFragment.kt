...
//        val editText = dialogView.findViewById<EditText>(R.id.editSearch)
//        val recyclerView = dialogView.findViewById<RecyclerView>(R.id.recyclerResults)
//
//        val adapter = PlaceSearchAdapter { place ->
//            // 장소 선택 시 동작
//            if (type == "A") binding.routeA.text = place.title
//            else binding.routeB.text = place.title
//
//            // 지도 이동 로직 추가 가능
//        }
//
